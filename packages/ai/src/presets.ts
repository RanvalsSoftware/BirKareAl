...
const STYLE_PRESETS: Record<string, string> = {
  ...
  hdr: 'A restrained photorealistic dynamic-range correction applied to the existing photograph: recover shadow and highlight detail while preserving the original light direction, scene geometry and natural skin tones. Keep pores, material texture and smooth tonal transitions. Do not invent texture or make the image look tone-mapped. No halos, crunchy hair, oversharpening, local-contrast outlines or excessive saturation.',
  bokeh:
    'A photorealistic optical depth-of-field edit on the existing photograph. Keep the subject, camera angle and environment unchanged; increase background defocus only according to plausible scene depth. Preserve crisp eyes, eyelashes, hair strands, glasses, ear edges and gaps between fingers. Do not blur facial features, repaint the background or invent circular bokeh lights where no real light source exists.',
  cinematic:
    'A photorealistic film-still color grade applied to the existing photograph, not a movie-poster reconstruction. Use controlled contrast, soft highlight roll-off, natural warm skin, restrained cool environmental shadows and subtle fine grain while preserving the selected environment, time of day, source geometry and dominant light direction. Do not invent dramatic relighting, smoke, unrelated night scenery or synthetic spectacle. No film bars or teal skin.',
  vintage:
    'A photorealistic understated analog-film response applied to the same photograph: gentle highlight halation, organic fine grain, slightly muted saturation and warm midtones. Preserve facial detail, source composition and neutral whites so it still reads as a real scanned photograph rather than a retro filter overlay. No sepia blanket, simulated damage, date stamp or film-frame border.',
  'black-white':
    'A photorealistic black-and-white conversion of the existing photograph with a rich natural luminance range and preserved skin texture. Separate hair, clothing and backdrop through believable midtones; retain eye catchlights and source light direction. No crushed shadows, chalky highlights, selective colored objects or excessive microcontrast.',
  cyberpunk:
    'A photorealistic cyan-and-magenta lighting treatment applied to the existing scene. Preserve the original objects, setting, camera angle and composition; add colored light only where a plausible source and reflective surface could support it, while keeping neutral facial fill and natural skin color. Do not invent a car, wet road, skyline, smoke or futuristic props. No brand marks, signage, readable text or recognizable franchise elements.',
  watercolor:
  ...
  'natural-light':
    'A restrained photorealistic correction that keeps the image recognizably the same photograph. Change only exposure, white balance and dynamic range unless an explicit localized edit is requested. Preserve the setting, camera angle, texture, small imperfections and accurate skin tones. No artificial makeup, age changes, reshaping or invented scenery. For landscapes and objects, preserve structure without inventing a person.',
  studio:
    'A photorealistic professional portrait-lighting treatment: a broad soft key from about 45 degrees, gently warm highlights, neutral skin midtones, restrained opposite-side fill and a subtle hair rim only where physically plausible. Shape the face through light rather than facial geometry changes. Preserve pores, fine lines, hair strands and natural catchlights without plastic smoothing. Keep the selected scene and source perspective; this lighting style must not replace the background or force a new pose.',
};
